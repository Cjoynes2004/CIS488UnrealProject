...
FGhostRun AGhostRacerMarble::GenerateStaffGhost() const
{
	...
	else
	{
		...
		PathPoints = {
			...
			FVector(-930, 50, 4412),
			// Ice level begin
			FVector(-2539, 171, 4500),
			FVector(-5789, -99, 4700),
			FVector(-7359, 2281, 4850),
			FVector(-7760, 5920, 4720),
			FVector(-7040, 8750, 4260),
			FVector(-5770, 8750, 3380),
			FVector(-4940, 8750, 3660),
			FVector(-4850, 8750, 3920),
			FVector(-1040, 8220, 3760),
			FVector(-1030, 8780, 3750),
			// Climb to cylinder platforms
			FVector(-1746, 6525, 6219),
			FVector(-990, 5020, 5490),
			FVector(460, 5410, 5530),
			FVector(760, 5670, 5440),
			FVector(1030, 5420, 5290),
			FVector(1370, 5670, 5210),
			FVector(1971, 5481, 5049),
			// Tilting platforms climb
			FVector(-5920, 6020, 7640),
			FVector(-6450, 5480, 7790),
			FVector(-7060, 4910, 7940),
			FVector(-7700, 4310, 8080),
			// Ice ramp factory section
			FVector(-6740, 3320, 8120),
			FVector(-5310, 3280, 8150),
			FVector(-4950, 3180, 8250),
			FVector(-4610, 3090, 8410),
			FVector(-4290, 3010, 8640),
			FVector(-4020, 2940, 8920),
			FVector(-3830, 2890, 9260),
			// Spiral climb
			FVector(-3810, 2880, 9230),
			FVector(-3550, 2800, 9960),
			FVector(-3510, 2790, 10350),
			FVector(-3610, 2780, 11120),
			FVector(-3990, 2780, 11810),
			FVector(-4530, 2780, 12260),
			FVector(-5210, 2780, 12510),
			FVector(-5990, 2780, 12510),
			FVector(-6710, 2780, 12250),
			FVector(-7280, 2780, 11770),
			FVector(-7660, 2780, 11110),
			FVector(-7790, 2780, 10360),
			FVector(-7660, 2780, 9600),
			FVector(-7300, 2780, 8960),
			FVector(-6740, 2770, 8490),
			FVector(-6020, 2650, 8230),
			FVector(-4910, 2450, 8200),
			FVector(-3760, 2240, 8280),
			// Ascent through spiral cubes (Cube103-113)
			FVector(50, 4380, 9620),
			FVector(204, 4196, 9480),
			FVector(-816, 3034, 9675),
			FVector(-1124, 3402, 9675),
			FVector(-1472, 3108, 9855),
			FVector(-1726, 2896, 10114),
			// Top section platforms
			FVector(-5620, 4410, 13420),
			FVector(-3180, 4410, 13630),
			FVector(160, 4410, 13950),
			FVector(-410, 7130, 14180),
			FVector(-1070, 8110, 14310),
			FVector(-2200, 8760, 14510),
			FVector(-4830, 8670, 14880),
			FVector(-5620, 3980, 15590),
			FVector(-4600, 3700, 17570),
			// Final climb
			FVector(-1960, 7810, 18410),
			FVector(-1980, 7020, 17950),
			FVector(-1980, 5750, 17070),
			FVector(-1980, 4920, 17350),
			FVector(35, 3480, 18497),
			FVector(-540, 3460, 18490),
			FVector(-1357, 3460, 18838),
			FVector(-1045, 5780, 20707)
		};
	}
